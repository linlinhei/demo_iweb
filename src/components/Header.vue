      ...
      <b-navbar toggleable="sm" type="dark" variant="success">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            ...
            <!-- <b-nav-item :to="{name:'user_center'}" v-if="$global.isLogin==true">用户中心</b-nav-item> -->
          </b-navbar-nav>
          ...
          <b-navbar-nav class="ml-auto">
            <b-nav-item-dropdown right>
              ...
              <b-dropdown-item
                ...
                :to="{name:'user_center'}"
              >{{uname}}的用户中心</b-dropdown-item>
              <b-dropdown-item href="#" v-if="$global.isLogin==true" @click="logout">退出</b-dropdown-item>
              <b-dropdown-item to="/register" v-if="$global.isLogin==false">注册</b-dropdown-item>
              <b-dropdown-item to="/login" v-if="$global.isLogin==false">登录</b-dropdown-item>
            </b-nav-item-dropdown>
          </b-navbar-nav>
        </b-collapse>
      </b-navbar>
